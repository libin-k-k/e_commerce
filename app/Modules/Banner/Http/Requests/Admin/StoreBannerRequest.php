...
class StoreBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'web_image' => ['required_without:mobile_image', 'nullable', 'image', 'max:10240'],
            'mobile_image' => ['required_without:web_image', 'nullable', 'image', 'max:10240'],
    ...
    {
        return [
            'web_image.required_without' => 'Upload a web banner or a mobile app banner.',
            'mobile_image.required_without' => 'Upload a web banner or a mobile app banner.',
        ];
    }
}
